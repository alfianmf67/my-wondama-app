...
function Testimonials() {
        ...
        return (
            <section id='testimonial' className="relative py-14 bg-[#D9D9D9]">
                <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
                    <div className="max-w-xl sm:text-center md:mx-auto">
                        <h3 className="text-gray-800 text-3xl font-semibold sm:text-4xl">
                            Apa endapat Mereka terhadap website kammi
                        </h3>
                    </div>
                    <div className="mt-12">
                        <ul className="grid items-center gap-4 sm:grid-cols-2 lg:grid-cols-2">
                            {
                                testimonials.map((item, idx) => (
                                    <li key={idx} className="bg-white rounded-xl border shadow-md">
                                        ...
                                        <figure>
                                            <blockquote>
                                                <p className="text-gray-800 text-lg font-semibold px-2 py-1">
                                                    {item.quote}
                                                </p>
                                            </blockquote>
                                            <div className="flex items-center gap-x-2 p-2 mt-6 bg-indigo-50">
