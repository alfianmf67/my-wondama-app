...
function Login (){
    ...
    //     axios.post("http://localhost:5000/login", {userName}).then((res) => {
    ...
    return (
       ...
       <input value={userName} type="email" name="userName" onChange={(e) => {setUserName(e.target.value)}} placeholder="Type here" className="input input-bordered input-primary w-full max-w-xs" />
       <input value={password} type="password" name="password" onChange={(e) => {setPassword(e.target.value)}} placeholder="Type here" className="input input-bordered input-primary w-full max-w-xs" />
